...
Why does the bank need this analysis
...
1. Customer Analysis
Customer Base
The bank has 500 customers across the available dataset.
...
202 customers, representing approximately 40.4% of the customer base, hold more than one account.
...
The combined balance across all accounts is approximately:
...
The dataset contains 10,000 transactions with a combined transaction value of approximately:
...
Enugu Central has the highest aggregate loan value at approximately:
